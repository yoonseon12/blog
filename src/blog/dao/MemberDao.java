...
public class MemberDao {
	...
	public void updateMemberPw(Member member) throws Exception {
		String sql="UPDATE blog_member SET member_pw=? WHERE member_id=?";
		String PW = null;
		try {
			conn = DBUtil.getConection();
			stmt = conn.prepareStatement(sql);
	...
	public Member SelectMemberPw(Member member) throws Exception {
		...
		Member dbPw = null;
		String sql = "SELECT member_pw FROM blog_member WHERE member_id=?";
		try {
			conn = DBUtil.getConection();
			stmt = conn.prepareStatement(sql);
	...
	*/
	...
	public boolean selectMemberId(Connection conn, String memberId) throws SQLException {
		...
		String sql ="SELECT mi FROM "
				+ "(SELECT member_id as mi FROM blog_member "
				+ "UNION "
				+ "SELECT memberId as mi FROM blog_memberid) as t "
				+ "WHERE t.mi=?";
		PreparedStatement stmt = null;
		ResultSet rs = null;
		try {
